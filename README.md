...
5. **Octopipe** is in the standard Charles installation as a CD option. In addition, however, the usage of Octopipe is optional, it is possible to disable it at installation.
