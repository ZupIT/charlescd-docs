---
description: >-
  In this section, you will find how to install Charles via your Terraform local
  environment.
---

# Installing via Terraform local environment
...
For more information, check out the [**charlescd-local-cluster**](https://github.com/ZupIT/charlescd-local-cluster) repository.
...
When the installation is completed and the Istio Ingress pod is running, you'll be able to get its health check endpoint:
...
To save your computing resources, use a single Postgres instance. For this, create a script to configure all databases and their respective users:
...
Now, access ****[**http://charles.lvh.me/**](http://charles.lvh.me/) ****on your browser:
