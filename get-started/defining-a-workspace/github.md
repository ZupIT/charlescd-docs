...
* **Token**: check out GitLab's documentation[ **on how to create a token**](https://docs.gitlab.com/ee/api/#personalproject-access-tokens)**.** It's important to highlight that the token needs to have the following accesses: "**api", "read\_repository"** and **"write\_repository"**.
