...
4. **Git token:** insira um token de autenticação que tenha acesso repositório git onde está armazenado seus [**templates Helm**](../criando-modulos/configurando-o-chart-template.md) ****que serão utilizados durante o deployment da sua [**aplicação**](../criando-modulos/). Caso o seu Git Provider seja **GitHub**, é necessário a permissão "_repo_". Caso contrário, configure no **GitLab** os acessos: "_api_" e "_read\_repository_".
